  ...
  return (
    ...
    <h1 className="App text-center my-4">Calendar</h1>
      ...
      <h4>Add Event</h4>
        ...
        <button type="button" style={{ background: " #873cb3", color:"white" }} className="btn btn-light btn-sm" onClick={handleAddEvent}>
            Add 
        </button>
        
        </div>
        <div className="col-md-1">
        <button type="button" style={{ background: " #873cb3", color:"white" }} className="btn btn-light btn-sm" onClick={handleDelEvent}>
            Delete 
        </button>
        </div>
      </div>
